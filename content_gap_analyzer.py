...
class ContentGapAnalyzer:
    ...
    def _analyze_with_direct_gemini(self, article_content, article_url=None):
        ...
        """
        try:
            # Prepara il prompt semplificato per Gemini
            prompt = f"""
            Sei un esperto di analisi di contenuti. Confronta questo articolo con l'AI Overview e fornisci un'analisi dettagliata.
            ...
            1. Argomenti coperti dall'articolo
            2. Argomenti mancanti rispetto all'AI Overview
            3. Raccomandazioni specifiche per migliorare il contenuto
            4. Valutazione della qualità complessiva
            
            Fornisci una risposta dettagliata e strutturata.
            """
    ...
    def _get_direct_gemini_recommendations(self, missing_topics: List[Dict], article_content: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            prompt = f"""
            Basandoti sull'AI Overview e sull'articolo forniti, genera raccomandazioni specifiche per migliorare l'articolo.
            ...
            Genera raccomandazioni specifiche in formato JSON:
            [
                {{
                    "title": "Titolo della raccomandazione",
                    "description": "Descrizione dettagliata di cosa aggiungere",
                    "topic": "Argomento correlato",
                    "priority": "alta|media|bassa",
                    "impact": "alto|medio|basso",
                    "type": "critico|strutturale|generale",
                    "relevance_score": 0.8,
                    "implementation": "Come implementare concretamente",
                    "where_to_add": "Dove inserire nell'articolo",
                    "added_value": "Valore aggiunto per il lettore"
                }}
            ]
            
            Fornisci massimo 8 raccomandazioni, ordinate per priorità.
            """
